...
# set the SPARK
spark_conf = SparkConf().setAppName('es-spark')
...
match_day = {'sort': {'@timestamp': {'order': 'asc'}}, 'query': {'range': {'@timestamp': {'gte': (now - interval_day).strftime('%Y-%m-%dT%H:00:00'), 'lt': now.strftime('%Y-%m-%dT%H:00:00')}}}}
