...
{
    var my_url = "/softbei_wifi/SelectNewAndOldCustomersDay";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_new_and_old_customers_day_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_new_customers_day_data;
var the_old_customers_day_data;
var new_and_old_customers_day_time
function select_new_and_old_customers_day_callback(data)
{
            var obj = JSON.parse(data);
            the_new_customers_day_data = obj["new_customers"];
            the_old_customers_day_data = obj["old_customers"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time;
            select_chart_new_and_old_customers_day();
}

function select_chart_new_and_old_customers_day()
{
              require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
