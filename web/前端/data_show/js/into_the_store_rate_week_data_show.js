$(document).ready(function(){
    ...
    function chart_into_the_store_rate_week(){
			  ...
			  window.onresize = into_the_store_rate_week.resize;
              }
              );
          }
...
{
    var my_url = "/softbei_wifi/SelectIntoTheStoreRateWeek";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_into_the_store_rate_week_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_into_the_store_rate_week_data;
var into_the_store_rate_week_time;
function select_into_the_store_rate_week_callback(data)
{
            var obj = JSON.parse(data);
            the_into_the_store_rate_week_data = obj["into_the_store_rate"];
            into_the_store_rate_week_time = obj["time"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time;
            select_chart_into_the_store_rate_week();
}

function select_chart_into_the_store_rate_week()
{
              require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
