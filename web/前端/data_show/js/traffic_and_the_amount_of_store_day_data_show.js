...
{
    var my_url = "/softbei_wifi/SelectTrafficAndTheAmountOfStoreDay";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_traffic_and_the_amount_of_store_day_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_traffic_day_data;
var the_store_amount_day_data;
var traffic_and_the_amount_of_store_day_time;
function select_traffic_and_the_amount_of_store_day_callback(data)
{
            var obj = JSON.parse(data);
            the_traffic_day_data = obj["traffic"];
            the_store_amount_day_data = obj["store_amount"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time; 
            select_chart_traffic_and_the_amount_of_store_day();
}

function select_chart_traffic_and_the_amount_of_store_day()
{
    require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
