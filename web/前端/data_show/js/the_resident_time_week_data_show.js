...
{
    var my_url = "/softbei_wifi/SelectTheResidentTimeWeek";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_resident_time_week_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_resident_time_week_data;
var resident_time_week_time;
function select_resident_time_week_callback(data)
{
            var obj = JSON.parse(data);
            the_resident_time_week_data = obj["resident_time"];
            resident_time_week_time = obj["time"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time;
            select_chart_resident_time_week();
}

function select_chart_resident_time_week()
{
              require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
