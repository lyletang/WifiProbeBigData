...
{
    var my_url = "/softbei_wifi/SelectTrafficAndTheAmountOfStoreWeek";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_traffic_and_the_amount_of_store_week_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_traffic_week_data;
var the_store_amount_week_data;
var traffic_and_the_amount_of_store_week_time;
function select_traffic_and_the_amount_of_store_week_callback(data)
{
            var obj = JSON.parse(data);
            the_traffic_week_data = obj["traffic"];
            the_store_amount_week_data = obj["store_amount"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time;
            select_chart_traffic_and_the_amount_of_store_week();
}

function select_chart_traffic_and_the_amount_of_store_week()
{
              require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
