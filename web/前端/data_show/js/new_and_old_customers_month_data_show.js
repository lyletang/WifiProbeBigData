...
{
     var my_url = "/softbei_wifi/SelectNewAndOldCustomersMonth";
     ...
     $.ajax({
       ...
       url: my_url,
       data: request_time,
       success: select_new_and_old_customers_month_callback,
       error: function(data)
       {
           alert("失败！");
       }
...
var the_new_customers_month_data;
var the_old_customers_month_data;
var new_and_old_customers_month_time;
function select_new_and_old_customers_month_callback(data)
{
            var obj = JSON.parse(data);
            the_new_customers_month_data = obj["new_customers"];
            the_old_customers_month_data = obj["old_customers"];
            ...
            document.getElementById("start_date").value = start_time;
	        document.getElementById("end_date").value = end_time;
            select_chart_new_and_old_customers_month();
}

function select_chart_new_and_old_customers_month()
{
              require.config({
                  paths:{
                  echarts:'http://echarts.baidu.com/build/dist'
