...
$(function() {
    ...
    $('#bar .picture,#bar .pencil,#bar .banner').click(function(event) {
        ...
        if (leiname == 'picture') {
            ...
            str = '<li class="ui-widget-content ui-corner-tr ui-state-default ' + leiname + ' ' + leiname + i + '" name="' + leiname + i + '"><a data="" class="datahref"><span class="ui-widget-header"></span><div class="maininfo"><input name="" type="file' + i + '" id="up_FILE' + i + '" class="imghide bindname" /><img src="" ondblclick="upload(this,' + i + ',1)" src="public/media/image/favicon.png" class="uploadimg" /></div></a></li>';
...
function sbm(a) {
    ...
    // localStorage.setItem('key', JSON.stringify(obj));  //输出
...
function cel(b) {
    ...
    $datainfo.find("." + name + ' .yu_txtcol').val("").css('background-color','');
