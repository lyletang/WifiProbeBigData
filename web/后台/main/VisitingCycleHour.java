...
public class VisitingCycleHour extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		while(true)
		{
			...
			s_time = s_year + "." + ProcessNumber.processNumber(s_month) + "." + ProcessNumber.processNumber(s_day) + "." + ProcessNumber.processNumber(s_hour);
			time.add(s_time);
